...
class AboutTab extends BaseTab {
    constructor() {
        super();
        this.id = 'about';
        this.name = TimelineI18n.getMessage('aboutTabName') || '关于插件';
        ...
        container.innerHTML = `
            <div class="about-share-actions">
                <a href="https://timeline4ai.com/#/guide?section=timeline" target="_blank" class="about-share-action-btn">
                    ...
                    ${TimelineI18n.getMessage('aboutBtnDocs') || '功能文档'}
                </a>
                <a href="https://chromewebstore.google.com/detail/fgebdnlceacaiaeikopldglhffljjlhh?utm_source=item-share-cb" target="_blank" class="about-share-action-btn">
                    ...
                    ${TimelineI18n.getMessage('aboutBtnChrome') || 'Chrome 安装'}
                </a>
                <a href="https://microsoftedge.microsoft.com/addons/detail/ai-timeline%EF%BC%9Agemini%E3%80%81chatgp/ekednjjojnhlajfobalaaihkibbdcbab" target="_blank" class="about-share-action-btn">
                    ...
                    ${TimelineI18n.getMessage('aboutBtnEdge') || 'Edge 安装'}
                </a>
                <a href="https://addons.mozilla.org/en-US/firefox/addon/ai-timeline/" target="_blank" class="about-share-action-btn">
                    ...
                    ${TimelineI18n.getMessage('aboutBtnFirefox') || 'Firefox 安装'}
                </a>
                <a href="https://github.com/houyanchao/chatgpt-gemini-timeline" target="_blank" class="about-share-action-btn">
                    ...
                    ${TimelineI18n.getMessage('aboutBtnGithub') || 'GitHub 开源'}
                </a>
            </div>
            ...
            <div class="about-section">
                ...
                <div class="about-section-body">
                    <div class="about-section-title">${TimelineI18n.getMessage('aboutPluginTitle') || '插件简介'}</div>
                    <div class="about-section-content">${TimelineI18n.getMessage('aboutPluginContent') || 'Timeline 是专为浏览器端 AI 对话开发的提效插件，拥有 时间轴、文件夹、文本高亮、复制 LaTeX 公式、自定义提示词等超多功能，把效率拉爆。支持 ChatGPT、Gemini、Claude、DeepSeek、Kimi、豆包、千问等所有主流 AI 平台。'}</div>
                </div>
            </div>
            ...
            <div class="about-section">
                ...
                <div class="about-section-body">
                    <div class="about-section-title">${TimelineI18n.getMessage('aboutDataSecurityTitle') || '数据安全'}</div>
                    <div class="about-section-content">${TimelineI18n.getMessage('aboutDataSecurityContent') || '你的所有数据都存储在浏览器本地或你的 Google Drive 中，插件不会收集、上传或分享你的任何对话内容和个人信息，本项目已在 GitHub 开源，可随时审查代码。'}</div>
                </div>
            </div>
            ...
            <div class="about-section">
                ...
                <div class="about-section-body">
                    <div class="about-section-title">${TimelineI18n.getMessage('aboutDeveloperTitle') || '开发者'}</div>
                    <div class="about-section-content">
                        ${TimelineI18n.getMessage('aboutDeveloperContent') || '本项目由我和 Claude Opus 4.6 共同维护，每周 1~2 新版本的更新节奏。如果想提需求或反馈 bug，可通过以下渠道进行反馈（我看到一定会回复）：'}
                        <div class="about-feedback-blocks">
                            <a href="https://chromewebstore.google.com/detail/fgebdnlceacaiaeikopldglhffljjlhh?utm_source=item-share-cb" target="_blank" class="about-feedback-block">
                                ...
                                <span>${TimelineI18n.getMessage('aboutFeedbackStore') || 'Chrome 商店评价区'}</span>
                            </a>
                            <a href="https://github.com/houyanchao/chatgpt-gemini-timeline/issues" target="_blank" class="about-feedback-block">
                                ...
                                <span>${TimelineI18n.getMessage('aboutFeedbackGithub') || 'GitHub Issues'}</span>
                            </a>
                            <div class="about-feedback-block about-feedback-email" data-email="houyanchao@outlook.com">
                                ...
                                <span>${TimelineI18n.getMessage('aboutFeedbackEmail') || '邮件联系'}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            this.addEventListener(emailItem, 'click', () => {
                ...
                navigator.clipboard.writeText(email).then(() => {
                    if (window.globalToastManager) {
                        window.globalToastManager.success(TimelineI18n.getMessage('xpzmvk') || '复制成功');
                    }
                });
            });
        }
